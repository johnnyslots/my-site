      ...
      <div className='projects-details-container'>
        <div className='projects-item-container'>
          <div>
            ...
            <h4 className='projects-visit'><a target="_blank" className='projects-visit-link' href='http://www.codebono.org/'>VISIT</a></h4>
        ...
        <div className='projects-item-container'>
          ...
          <div>
            ...
            <h4 className='projects-visit'><a target="_blank" className='projects-visit-link' href='https://expo.io/@yonislots/checkit-app'>VISIT</a></h4>
            <div className='projects-links-border'>
              <Icon name='sitemap' size='small'></Icon>
            </div>
        ...
        <div className=' projects-item-container no-border'>
          <div>
            ...
            <h4 className='projects-visit'><a target="_blank" className='projects-visit-link' href='https://dd-wine.herokuapp.com/'>VISIT</a></h4>
            <div className='projects-links-border'>
              <Icon name='sitemap' size='small'></Icon>
            </div>
