import fullstackIcon from './images/fullstack-icon.png';
import uberIcon from './images/uber-icon.png';
import soundstreakIcon from './images/soundstreak-icon.png';
import hunterCollegeIcon from './images/hunter-college-icon.png';
